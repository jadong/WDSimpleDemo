...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabViewLayoutId = typedArray.getResourceId(R.styleable.SlidingTabLayout_tabCBackground, mTabViewLayoutId);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            setCurrentSelectTextColor(position);
     ...
     * @param position 位置
     */
    public void setCurrentSelectTextColor(int position) {
        if (mTabStrip == null) {
            return;
        }
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            ...
            if (position == i) {
                ...
                if (view instanceof TextView) {
                    ((TextView) view).setTextColor(Color.parseColor("#fe4070"));
                }
            } else {
                if (view instanceof TextView) {
